# Personal portfolio based on Sass 7-1 Architecture Pattern

This is site is using the [7-1 architecture pattern](http://sass-guidelin.es/#architecture) and sticking to [Sass Guidelines](http://sass-guidelin.es) writing conventions.
